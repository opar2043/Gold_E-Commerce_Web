...
// const supabase = createClient('https://rldujrqylzgeqfmlvejo.supabase.co','eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJsZHVqcnF5bHpnZXFmbWx2ZWpvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTUzMjQ3MjgsImV4cCI6MjA3MDkwMDcyOH0.bvsKIAqn-rPOkPUqQr_LS5zGb-HvxaFUXIukM79zDqE');
...
//     const password_hash = event.pass.value;
//     const street_address = event.street_address.value;
//     const postal_code = event.postal_code.value;
//     const country = event.country.value;
//     const phone = event.phone.value;
//     const city = event.city.value;
...
//         return addUserToSupabase(userObj);
//       })
//       .catch((error) => {
