      ...
      <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="sticky top-4">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 border rounded-md text-sm font-medium transition-colors ${
                          selectedSize === size
                            ...
                            : 'border-gray-300 bg-white text-gray-700 hover:border-[#FB8911]'
                        }`}
                      >
                        {size}
                      </button>
              ...
              <div className="mb-8">
                <div className="flex gap-3 mb-4">
                  ...
                  <button className="px-4 py-3 rounded-lg border-2 border-gray-300 bg-white text-gray-600 hover:bg-gray-50 transition-colors">
                    <FiShare2 size={20} />
                  </button>
                </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm">
            {activeTab === 'description' && (
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  This exquisite piece represents the finest craftsmanship in jewelry making. 
                  Each detail has been carefully considered to create a timeless piece that 
                  will be treasured for generations. Our artisans use traditional techniques 
                  combined with modern precision to ensure the highest quality standards.
                </p>
              </div>
            )}
            ...
            {activeTab === 'reviews' && (
              <div>
                ...
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-sm mt-2">Average rating: {product.rating}/5 based on {product.reviews} reviews</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'shipping' && (
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Shipping & Returns</h3>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-600 space-y-1">
                      ...
                      <li>• Lifetime warranty on gold jewelry</li>
                    </ul>
                  </div>
                </div>
              </div>
