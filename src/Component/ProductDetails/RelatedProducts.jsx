  ...
  return (
    <div className="mt-16">
      ...
      <div className="text-center mt-8">
        <Link
          to="/collection"
          className="inline-flex items-center px-6 py-3 bg-white border-2 border-[#FB8911] text-[#FB8911] rounded-lg font-semibold hover:bg-[#FB8911] hover:text-white transition-colors duration-300"
        >
          View All Products
        </Link>
      </div>
