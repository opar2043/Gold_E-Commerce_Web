        ...
        <div className="navbar-center flex flex-col lg:flex-row items-center gap-2 lg:gap-6">
          ...
          <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
            <input
              ...
              className="w-full pl-12 pr-4 py-3 text-sm md:text-base border-2 border-gray-300 rounded-full bg-[#FAF7F2] shadow-sm focus:outline-none focus:border-[#FB8911] focus:ring-2 focus:ring-[#FB8911]/20 transition-all duration-200 placeholder-gray-500"
            />
