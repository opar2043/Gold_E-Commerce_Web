...
>>>>>>> f85b4fd4fc0aad260ad61acb3c0403664cd6cf7f

      {/* Lower Navbar - Navigation */}
      <div className="navbar bg-[#F6F1EC] md:px-10">
        ...
        <div className="navbar-center flex flex-col lg:flex-row items-center gap-2 lg:gap-6">
          ...
          <div className="relative w-full max-w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto ">
            <input
              ...
              className="w-full pl-12 pr-4 py-2.5 sm:py-3 text-sm sm:text-base border-2 border-gray-300 rounded-full bg-[#FAF7F2] shadow-sm focus:outline-none focus:border-[#FB8911] focus:ring-2 focus:ring-[#FB8911]/20 transition-all duration-200 placeholder-gray-500"
            />
            <FiSearch
