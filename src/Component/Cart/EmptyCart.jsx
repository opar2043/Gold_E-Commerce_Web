...
const EmptyCart = () => {
  const featuredCategories = [
    ...
    },
    {
      ...
      path: '/collection/diamond-jewelry', 
      icon: '💎',
      description: 'Sparkling diamonds'
    },
    {
      name: 'Watches',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredCategories.map((category) => (
              <Link
                key={category.name}
                to={category.path}
                className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300 group text-center"
              >
