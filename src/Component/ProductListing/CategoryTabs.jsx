        ...
        <button
          ...
          className={`px-6 py-3 rounded-full font-medium text-sm md:text-base transition-all duration-300 ${
            selectedCategory === 'all'
              ...
              : 'bg-white text-gray-700 hover:bg-[#FB8911]/10 hover:text-[#FB8911] shadow-sm'
          }`}
        >
          All Collections
        </button>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-base leading-relaxed max-w-3xl mx-auto">
              ...
              modern diamond creations. Each piece is carefully crafted with attention to detail 
