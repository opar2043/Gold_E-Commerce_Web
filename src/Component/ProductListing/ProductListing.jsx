              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                  selectedSubcategory === 'all'
                    ...
                    : 'bg-white text-gray-700 hover:bg-[#FB8911]/10'
                }`}
              >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex border border-gray-300 rounded-md overflow-hidden">
                  <button
                    ...
                    className={`p-2 ${viewMode === 'grid' ? 'bg-[#FB8911] text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
                  >
                    <FiGrid size={16} />
                  </button>
                  <button
                    onClick={() => setViewMode('list')}
                    className={`p-2 ${viewMode === 'list' ? 'bg-[#FB8911] text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
                  >
                    <FiList size={16} />
                  </button>
                </div>
